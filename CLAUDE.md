...
- **restart.sh** — Restarts all services: kills old processes, replaces `.new` binaries, restores `.processing` queue files, starts preparer + gpu_scheduler + youtube_upload --watch + status_server. Usage: `./restart.sh [NUM_GPUS]`.
