...
- **pimp_brightness.sh** — Efficient brightness adjustment for a specific time segment. Only re-encodes the affected segment (gamma correction), stream-copies the rest. Usage: `./pimp_brightness.sh <input.mp4> <start> <end> <percent> [output.mp4]`. Percent: `-25` = 25% darker, `+30` = 30% brighter. Timestamps: `0:33`, `1:48:05`, or plain seconds.
