...
- **Datacenter GPUs are NOT suitable**: A100 80GB = 0.07 fps, L40S 48GB = 0.3 fps, RTX Pro 6000 WS Max-Q = 0.44 fps. All slower than RTX 5090 (0.5 fps) despite more VRAM. Real-ESRGAN needs high clock speed + high TDP (>500W), not more VRAM. Consumer GPUs (RTX 4090/5090) always win.
