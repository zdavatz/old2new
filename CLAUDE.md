...
- **GH200 Grace Hopper is the FASTEST GPU tested**: 0.74 fps at $2.26/hr (RunCrate). The integrated ARM Grace CPU + NVLink to H100 GPU eliminates the PCIe CPU↔GPU bottleneck that limits all other GPUs. 292W power draw at 1980 MHz. However, it's ARM64 (aarch64) — our x86_64 Docker images don't work, must install deps directly. Still not cost-effective vs RTX 5090 ($0.30-0.76/hr at 0.51 fps = $0.0002-0.0004/frame vs GH200 $0.00085/frame).
