...
- Auto-tiling for VRAM management: RTX 4090 (24GB) safe up to 1.6 MP, RTX 5090 (32GB) up to 1.8 MP, L40S/A6000 (48GB) up to 2.0 MP, 80GB up to 4.0 MP. Higher resolutions automatically use tile=512 or smaller. Tiling is ~3x slower at 2.3 MP. VRAM scales super-linearly because RealESRGAN_x4plus always processes at 4x internally — 1920x1200 input needs ~50GB VRAM for no-tile mode. 1920x1200 (2.3 MP) confirmed OOM on 48GB and 7.5s/frame (swapping) on 32GB without tiling.
